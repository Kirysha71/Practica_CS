...
namespace GradeJournal.ViewModels
{
    public class JournalViewModel : INotifyPropertyChanged
    {
        ...
        public JournalViewModel(UserModel user)
        {
            ...
            NotifyCommand = new RelayCommand(_ => SendNotification());
        }
        ...
        private async void SaveDataAsync()
        {
            ...
            MessageBox.Show("Данные сохранены в journal.json", "Сохранение", MessageBoxButton.OK, MessageBoxImage.Information);
        }
        ...
        private void EditStudent()
        {
            ...
            {
                MessageBox.Show("Выберите студента для редактирования!", "Внимание", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
        ...
        private void SendNotification()
        {
            ...
            service.Send($"Новое домашнее задание от {_user.FullName}!");
            MessageBox.Show("Уведомление отправлено через Memory-Mapped File", "Информация", MessageBoxButton.OK, MessageBoxImage.Information);
        }
